...
export default function SocialPromoSection() {
  ...
  const handleWhatsAppShare = () => {
    window.open(
      `https://wa.me/?text=${encodeURIComponent(`${siteMsg} ${siteUrl}`)}`,
      "_blank",
    );
  };
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 rounded-xl text-white font-hindi font-semibold text-sm shadow-md hover:opacity-90 transition-opacity"
            ...
            >
              <svg
                ...
                role="img"
                aria-labelledby="fb-icon-promo"
              >
                <title id="fb-icon-promo">Facebook</title>
            ...
            >
              <svg
                ...
                className="w-5 h-5 fill-current"
                role="img"
                aria-labelledby="wa-icon-promo"
              >
                <title id="wa-icon-promo">WhatsApp</title>
            ...
            >
              <svg
                ...
                className="w-5 h-5 fill-current"
                role="img"
                aria-labelledby="ig-icon-promo"
              >
                <title id="ig-icon-promo">Instagram</title>

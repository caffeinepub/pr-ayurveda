...
export default function ProductsSection() {
  ...
  const visible = products.slice(startIdx, startIdx + visibleCount);
  ...
  const handleAddToCart = async (productId: bigint, name: string) => {
    try {
      ...
      toast.error("कार्ट में जोड़ने में त्रुटि हुई");
    }
  };
          ...
          <div className="flex justify-end mb-6">
            <div className="flex gap-3">
              ...
              <button
                type="button"
                onClick={handleNext}
                disabled={startIdx >= products.length - visibleCount}
                className="w-10 h-10 rounded-full border-2 border-brand-green flex items-center justify-center hover:bg-brand-green hover:text-white transition-colors disabled:opacity-40"
          ...
          >
            {visible.map((product, i) => (
              <motion.div
                ...
                data-ocid={`products.item.${startIdx + i + 1}`}
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      data-ocid={`products.item.${startIdx + i + 1}.button`}
                    >
